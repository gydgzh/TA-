Shader "Custom/Environment/Ice_Transparent"
{
    Properties
    {
...
//        _HeightTiling("HeightTiling",Range(0,100)) = 1
        ...
        _SceneColorIntensity("SceneColorIntensity",Range(0,3)) = 0.1
...
//            Blend one zero
        ...
        half3 SpiralBlur(float4 positionCS,int RadialSteps,int DistanceSteps,half Distance)
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                half distnace = _Distance * (1-f);
                half3 sceneColor = SpiralBlur(input.positionCS,16,16,distnace);
                color.rgb = color.rgb + sceneColor * _SceneColorIntensity;
