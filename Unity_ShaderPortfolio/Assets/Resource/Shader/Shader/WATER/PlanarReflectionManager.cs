...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class PlanarReflections : MonoBehaviour
    {
        ...
        private readonly int _planarReflectionTextureId = Shader.PropertyToID("_PlanarReflection");
        ...
        private void OnEnable()
        {
            ...
            // RenderPipelineManager.beginContextRendering += ExecutePlanarReflections;
